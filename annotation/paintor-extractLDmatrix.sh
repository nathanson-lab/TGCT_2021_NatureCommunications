...
# this is the output from plotCond.sh
...
# really dont want this command to fail and overwrite the imputed data
if [ $? -ne 0 ]
then
...
CMD="plink1.09 --vcf ${CHRDIR}/chr${CHR}.qc.vcf.gz --extract snplst1 --double-id --r2 square --out $SNPNAME"
eval $CMD
