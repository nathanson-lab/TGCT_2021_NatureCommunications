...
# imputed gwas data- this is the replication set only bc
# we need genotype data
...
awk -v bp="$BP" -v win="$WINDOW" '$4 > bp - win * 1000 && $4 < bp + win * 1000 {
print $2}' ${BFILE}.bim > SNPLST
